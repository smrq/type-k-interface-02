...
const PROGMEM Keymap_t keymap = {
	.layers = {
		KEYMAP_LAYER(
			KC_USER(0), KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F21,   KC_F22,   KC_F23,   KC_F24,    KC_PLAY,    KC_PREV,  KC_MEDIA_SELECT,  KC_NEXT,  KC_MY_COMPUTER, KC_AUDIO_MUTE,
			KC_ESC,     KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,    KC_F10,   KC_F11,   KC_F12,    KC_USER(1), KC_PRSC,     KC_SCRLK, KC_PAUSE,    KC_CALCULATOR,       KC_USER(2),
			...
			KC_LSHIFT,          KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMMA, KC_DOT,   KC_SLASH,            KC_RSHIFT,  KC_USER(3),  KC_UP,    KC_USER(4),  KC_KP_1,  KC_KP_2,   KC_KP_3,
			KC_LCTRL,           KC_USER(5),     KC_LALT,        KC_SPACE,       KC_APP,           KC_RALT,            KC_RGUI,   KC_RCTRL,   KC_LEFT,     KC_DOWN,  KC_RIGHT,    KC_KP_0,             KC_KP_DOT, KC_KP_ENTER
		)
	},
	.encoder = {
		.cw = KC_AUDIO_VOL_UP,
